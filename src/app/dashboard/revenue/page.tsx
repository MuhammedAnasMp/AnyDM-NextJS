...
export default function RevenuePage() {
  ...
  useEffect(() => {
    const handleRefresh = () => fetchRevenue(timeframe, true);
    window.addEventListener("refresh-dashboard-revenue", handleRefresh);
    window.addEventListener("refresh-active-page", handleRefresh);
    return () => {
      window.removeEventListener("refresh-dashboard-revenue", handleRefresh);
